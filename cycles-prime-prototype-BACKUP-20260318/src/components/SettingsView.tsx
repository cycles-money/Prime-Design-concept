...
import { EyeOff, Eye, Users, ChevronRight } from 'lucide-react';
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="bg-white dark:bg-[var(--color-1)] rounded-2xl shadow-md overflow-hidden">
      <div className="px-5 py-3.5 border-b border-gray-200 dark:border-[var(--border)] bg-gray-50 dark:bg-[var(--surface-3)]">
  ...
  return (
    <div className="flex items-start gap-4">
      <div className="w-48 flex-shrink-0 pt-2">
        ...
        {description && (
          <p className="text-2xs text-gray-500 dark:text-gray-300 mt-0.5 leading-relaxed">{description}</p>
        )}
      </div>
    ...
    <div className="flex flex-col h-full overflow-y-auto bg-gray-50 dark:bg-[var(--surface-2)]">
      <div className="max-w-3xl mx-auto w-full px-6 py-6 space-y-5">
        ...
        <Section title="Lynq API Integration">
          ...
          {/* Connection status */}
          <div className="flex items-center gap-2 mb-5 pb-4 border-b border-gray-100 dark:border-[var(--border)]">
        ...
        <div className="bg-white dark:bg-[var(--color-1)] rounded-2xl shadow-md px-5 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-[var(--color-50)] dark:bg-[var(--color-950)]/20 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-2xs text-gray-500 dark:text-gray-300 mt-0.5">
